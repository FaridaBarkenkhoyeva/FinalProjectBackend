...
const neurologicalScreeningModel = sequelize.define(
  "NeurologicalScreening",
  {
    ...
    sixMinuteWalkDistance: { type: DataTypes.DECIMAL, allowNull: true },
    singleLegStanceTime: { type: DataTypes.DECIMAL, allowNull: true },
    rombergTestResult: { type: DataTypes.STRING, allowNull: true },
  },
  {
    timestamps: true,
  }
